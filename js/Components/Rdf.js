...
RDF._baseLiteralType = RDF._baseType.extend({
    baseType : "Literal"
});
...
RDF._dataTypes[$_RDFS("Literal").hash] = new (RDF._baseLiteralType.extend({
    uri : $_RDFS("Literal").uri,
    parse : __identity,
    sparqlFormat : function(x){ return '"'+x+'"' }
}))();

RDF._dataTypes[$_XMLS("integer").hash] = new (RDF._baseLiteralType.extend({
    uri : $_XMLS("integer").uri,
    parse : parseInt,
    sparqlFormat : str
}))();

RDF._dataTypes[$_XMLS("float").hash] = new (RDF._baseLiteralType.extend({
    uri : $_XMLS("float").uri,
    parse : parseFloat,
    sparqlFormat : str
}))();

RDF._dataTypes[$_XMLS("string").hash] = new (RDF._baseLiteralType.extend({
